...
import * as sty from "./PlasmicBaseCard.module.css"; // plasmic-import: JWxCnuY5P_Vjpc/css
...
function PlasmicBaseCard__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div
        className={classNames(defaultcss.all, sty.box__pr5M, {
          [sty.box__long__pr5MWpAuF]: hasVariant(variants, "long", "long")
        })}
      >
        {p.renderPlasmicSlot({
          defaultContents:
      ...
      {(hasVariant(variants, "long", "long") ? true : false) ? (
        <div
          className={classNames(defaultcss.all, sty.box__xWaGl, {
            [sty.box__long__xWaGLwpAuF]: hasVariant(variants, "long", "long")
          })}
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <svg
                className={classNames(defaultcss.all, sty.svg__cKUcW)}
                role={"img"}
              />
            ),
