...
import BaseCard from "../../BaseCard"; // plasmic-import: JWxCnuY5P_Vjpc/component
...
import * as sty from "./PlasmicPlan.module.css"; // plasmic-import: 3zhCG-MdjA3_jv/css
...
function PlasmicPlan__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(defaultcss.all, sty.box__koHz)}>
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(defaultcss.all, sty.box__gFi2W)}
        >
          {p.renderPlasmicSlot({
          ...
          {p.renderPlasmicSlot({
            defaultContents: (
              <p.Stack
                as={"div"}
                hasGap={true}
                className={classNames(defaultcss.all, sty.box__eLgp)}
              >
                <Bullet
                  className={classNames("__wab_instance", sty.bullet__yA841)}
                />

                <Bullet
                  className={classNames("__wab_instance", sty.bullet__vbit)}
                />

                <Bullet
                  className={classNames("__wab_instance", sty.bullet__uFbL5)}
                />
              </p.Stack>
            ),
          ...
          <div className={classNames(defaultcss.all, sty.box__aBycv)}>
            {p.renderPlasmicSlot({
              defaultContents: (
                <LinkButton
                  text={"Get started"}
