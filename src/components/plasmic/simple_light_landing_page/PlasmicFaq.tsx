...
import * as sty from "./PlasmicFaq.module.css"; // plasmic-import: CuLhPqG6Q_TT8T/css
  ...
  return (
    ...
    >
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(defaultcss.all, sty.box__uy811)}
      >
        <div className={classNames(defaultcss.all, sty.box__vEdIw)}>
          <div className={classNames(defaultcss.all, sty.box__cTxjL)}>
            {p.renderPlasmicSlot({
