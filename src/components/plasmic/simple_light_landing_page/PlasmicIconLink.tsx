...
import * as sty from "./PlasmicIconLink.module.css"; // plasmic-import: FbOBEQJq7Ab7Q/css
    ...
    >
      ...
      >
        {p.renderPlasmicSlot({
          defaultContents: (
            <svg
              className={classNames(defaultcss.all, sty.svg__znEbb)}
              role={"img"}
            />
          ),
