...
import Avatar from "../../Avatar"; // plasmic-import: J7tfLDvuopcN3Z/component
...
import * as sty from "./PlasmicTestimonial.module.css"; // plasmic-import: f6z5GiSCYY7TRX/css

import QuoteDashesIcon from "./icons/PlasmicIcon__QuoteDashes"; // plasmic-import: mrXww2zSkcVBZU/icon
import profilepic880Sg19PuCxEHc from "./images/profilepic.png"; // plasmic-import: 880Sg19PUCxEHc/picture
  ...
  return (
    ...
    >
      ...
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(defaultcss.all, sty.box__kwQ9F)}
      >
        <div
